...
def get_history_service(history_repo : HistoryRepository = Depends(get_hist_repo), department_service : DepartmentService = Depends(get_dept_service)):
    return HistoryService(history_repo=history_repo, department_service=department_service)
